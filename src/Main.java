...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Backlog backlog = new Backlog("Search Project", "3 years");
        backlog.addIssue("Install fitness app", 5);
        backlog.addIssue("integrate with laptop", 10);
        backlog.addIssue("integrate with companies", 15);
        backlog.addIssue("deal with client's", 25);
    ...
    private static void startSprint(LinkedList<scrumIssue>sprint){
        ...
        while (!quit){
            ...
            switch (action){
                case 0:
                    System.out.println("you are Loged out of the scrum tool");
                    quit = true;
                    break;
